        ...
        y = class t extends Uint8Array {
            ...
            toString(e = 'utf8', r = 0, n = this.length) {
                if (
                    ...
                    return '';
                if (e === 'utf8' || e === 'utf-8')
                    return is.decode(this.slice(r, n));
                if (e === 'base64' || e === 'base64url') {
...
function bn(t, e) {
    var r,
        ...
        A = k.precision;
    if (!t.s || !e.s)
        return e.s ? (e.s = -e.s) : (e = new k(t)), U ? D(e, A) : e;
    if (
        ((f = t.d),
        (C = e.d),
        (n = e.e),
    ...
    En = ue(() => {
        ...
        R.toPrecision = function (t, e) {
            ...
            return (
                t === void 0
                    ? ((r = V(i)),
                      (n = ke(i, r <= o.toExpNeg || r >= o.toExpPos)))
                    : (me(t, 1, De),
                      e === void 0 ? (e = o.rounding) : me(e, 0, 8),
                      (i = D(new o(i), t, e)),
                      (r = V(i)),
...
${a.backtrace}`,
            ...
            return a.map((g) =>
                g.errors && g.errors.length > 0
                    ? (this.loggerRustPanic ??
                      this.buildQueryError(g.errors[0]))
                    : { data: g }
            );
        throw f && f.length === 1
            ? new Error(f[0].error)
    ...
    getExternalAdapterError(e) {
        if (e.error_code === yl && this.config.adapter) {
            ...
            return (
                qt(n, 'External error with reported id was not registered'), n
            );
        }
    }
    async metrics(e) {
            ...
            try {
                ...
                if (
                    ...
                    (this._engineConfig = {
                        ...
                        datamodelPath: ot.join(
                            t.dirname,
                            t.filename ?? 'schema.prisma'
                        ),
