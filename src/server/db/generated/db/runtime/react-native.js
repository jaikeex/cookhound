...
var xi = he((et) => {
    ...
    function vt(e, t, r) {
        throw Math.floor(e) !== e
            ? (Xe(e, r),
              new Ye.ERR_OUT_OF_RANGE(r || 'offset', 'an integer', e))
            : t < 0
...
S.minus = S.sub = function (e) {
    ...
    if (
        ((r = ee(e.e / M)), (g = ee(R.e / M)), (u = u.slice()), (o = g - r), o)
    ) {
        for (
            h = o < 0,
                h
...
S.plus = S.add = function (e) {
    ...
    if (
        ((o = ee(h.e / M)), (n = ee(e.e / M)), (u = u.slice()), (i = o - n), i)
    ) {
        for (
            i < 0
                ? ((r = u), (i = -i), (s = g.length))
...
function ho(e) {
    ...
    function i(o) {
        ...
        if (l === 'bigint')
            return (
                o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), cr(u, o.toString())
            );
        throw Error($e + o);
    }
    if (
...
var Wn = class {
        ...
        async rollbackTransaction(t, r, n) {
            return __PrismaProxy.rollbackTransaction(
                this.engineObject,
                t,
                r,
                n
...
var Zt = class {
    ...
    async stop() {
        if (
            ...
            return (
                Ae('library is already stopping'), this.libraryStoppingPromise
            );
        if (!this.libraryStarted) return;
        let t = async () => {
...
${a.backtrace}`,
    ...
    getExternalAdapterError(t) {
        if (t.error_code === Op && this.config.adapter) {
            ...
            return (
                ar(n, 'External error with reported id was not registered'), n
            );
        }
    }
    async metrics(t) {
...
var Yn =
        ...
        (r) => {
            ...
            if (Nr(r))
                ...
                let [o, ...s] = r;
                (n = o),
                    (i = { values: bt(s || []), __prismaRawParameters__: !0 });
            } else
                switch (t) {
                    case 'sqlite':
                    case 'mysql': {
