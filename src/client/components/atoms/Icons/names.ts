...
export const icons = {
    ...
    chevronLeft: iconsSvg.ChevronLeftIcon,
    chevronRight: iconsSvg.ChevronRightIcon,
    chevronUp: iconsSvg.ChevronUpIcon,
    ...
    lightbulb: iconsSvg.LightbulbIcon,
    link: iconsSvg.LinkIcon,
    minus: iconsSvg.MinusIcon,
